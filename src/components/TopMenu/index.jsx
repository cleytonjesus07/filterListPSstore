...
export default function TopMenu() {
    ...
    return (
        <div className="w-full flex justify-between px-10 pt-10 pb-2 bg-black bg-opacity-40 select-none">
            ...
            <div>
                <span>All Games & Add-Ons <span className="bg-white bg-opacity-20 p-[.2em] px-[.5em] text-sm">22</span></span>
            </div>
        </div >
    )
}